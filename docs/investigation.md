...
Investigation case workflow and detector/dataset/feature versioning.
...
- **Terminal states**: CONFIRMED, DISMISSED, RESOLVED
- **Auto-escalation**: score ≥ 80 starts at HIGH_RISK instead of OBSERVED
- **Priority rules**:
...
All hashes are SHA-256 truncated to 12 hex chars, computed over sort-keyed
JSON so they are stable across runs and platforms.
